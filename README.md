...
```
<img src="Component%20Library/src/assets/examples/toasts_example.gif" alt="Toasts component example" width="500" style="border: 3px solid #000; border-radius: 8px;">
